...
public class Doctor_Account_Signup_Online {
    WebDriver driver;
    @org.junit.Test
    @DisplayName("A---Doctor SignUp without add optional details")
    @Test
    public  void Dr_Signup_Online_TS_01() throws InterruptedException {
        ...
        //--------------------------------PMDC No--------------------------------------------//
        driver.findElement(By.xpath("//input[@placeholder='PMDC#/Medical Registration Number']")).sendKeys("roeeee");
        Thread.sleep(3000);

        //--------------------------------Mobile No--------------------------------------------//
        driver.findElement(By.xpath("//input[@placeholder='1 (702) 123-4567']")).sendKeys("397-9652178");
        ...
        //--------------------------------First Name-------------------------------------------//
        driver.findElement(By.xpath("//input[@placeholder='First Name']")).sendKeys("New");
        Thread.sleep(3000);

        //--------------------------------Last Name-------------------------------------------//
        driver.findElement(By.xpath("//input[@placeholder='Last Name']")).sendKeys("OnlineAccount");
        Thread.sleep(3000);
    ...
    @Test
    public  void Dr_Signup_Online_TS_02() throws InterruptedException {
        driver = ChromeUtils.getChromeDriverDev();
        DevTools devTools = ((ChromeDriver) driver).getDevTools();
        devTools.createSession();
        devTools.send(Network.enable(Optional.empty(), Optional.empty(), Optional.empty()));
        ...
        //--------------------------------PMDC No--------------------------------------------//
        driver.findElement(By.xpath("//input[@placeholder='PMDC#/Medical Registration Number']")).sendKeys("reeeee");
        Thread.sleep(3000);

        //--------------------------------Mobile No--------------------------------------------//
        driver.findElement(By.xpath("//input[@placeholder='1 (702) 123-4567']")).sendKeys("397-9612178");
        ...
        email.sendKeys("newacounty@gmail.com");
        Thread.sleep(3000);
    ...
    @Test
    public  void Dr_Signup_Online_TS_03() throws InterruptedException {
        driver = ChromeUtils.getChromeDriverDev();
        Thread.sleep(3000);
    ...
    @Test
    public  void Dr_Signup_Online_TS_03_1() throws InterruptedException {
        driver = ChromeUtils.getChromeDriverDev();
        Thread.sleep(3000);
        driver.get("https://www.mareez-care.com/doctor/login");
        driver.manage().window().maximize();
        ...
        //--------------------------------PMDC No--------------------------------------------//
        driver.findElement(By.xpath("//input[@placeholder='PMDC#/Medical Registration Number']")).sendKeys("fdgtfdg");
        Thread.sleep(3000);

        //--------------------------------Mobile No--------------------------------------------//
        driver.findElement(By.xpath("//input[@placeholder='1 (702) 123-4567']")).sendKeys("30450125455");
    ...
    @Test
    public  void Dr_Signup_Online_TS_04() throws InterruptedException {
        driver = ChromeUtils.getChromeDriverDev();
        Thread.sleep(3000);
        driver.get("https://www.mareez-care.com/doctor/login");
        driver.manage().window().maximize();
    ...
    public  void Dr_Signup_TS_04_1() throws InterruptedException {
        ...
        //--------------------------------PMDC No--------------------------------------------//
        driver.findElement(By.xpath("//input[@placeholder='PMDC#/Medical Registration Number']")).sendKeys("d324");
        Thread.sleep(3000);

        //--------------------------------Mobile No--------------------------------------------//
        driver.findElement(By.xpath("//input[@placeholder='1 (702) 123-4567']")).sendKeys("30214569874");
